...
namespace Kata.Spec
{
    ...
    public class when_user_input_is_one_number
    {
        ...
        It should_return_same_input = () => { _result.Should().Be(3); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_adding_two_numbers
    {
        ...
        Because of = () => { _result = _systemUnderTest.Add("3,1"); };
    ...
    public class when_adding_unkwon_amount_of_numbers
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        It should_return_the_sum_of_an_unkwon_number_list = () => { _result.Should().Be(6); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    
    // Given the user input is two numbers when calculating the sum then it should return the sum of those numbers. (example "1,2" should equal 3)(Done)
